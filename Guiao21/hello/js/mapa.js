...
function mostraCoordenadas(e){
  ...
  s.innerHTML = "Latitude e Longitude = "+ e.latlng.lat + " e " + e.latlng.lng;
}
...
var pontos = [
  L.marker([40.633258, -8.659097], {icon: iconeUA}).bindPopup("DETI"),   //bindPopup mostra texto quando se clica no ponto
